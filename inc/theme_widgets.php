<?php
	...
	register_sidebar(array(
	  ...
	  'id' => 'sidebar-left',
	  'description' => esc_html__( 'Widgets in this area will be shown on the right-hand side.', 'DarkTheme' ),
	...
	//Default Footer Sidebar
	  register_sidebar(array(
		  ...
		  'id' => 'footer-sidebar',
		  'description' => esc_html__( 'Widgets in this area will be shown in Footer Area.', 'DarkTheme' ),
